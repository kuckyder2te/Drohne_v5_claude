...
// ── Motoren (PWM) ──────────────────────────────────────────
#define PIN_MOTOR_FL 11 // Front Left  yellow
#define PIN_MOTOR_FR 12 // Front Right  green
#define PIN_MOTOR_BR 13 // Back Right blue
#define PIN_MOTOR_BL 14 // Back Left white
